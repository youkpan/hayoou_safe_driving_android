...
extern "C" JNIEXPORT void JNICALL
Java_com_wzt_yolov5_LSTR_init(JNIEnv *env, jclass, jobject assetManager, jint yoloType, jboolean useGPU) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_wzt_yolov5_LSTR_detect(JNIEnv *env, jclass, jobject image, jdouble threshold, jdouble nms_threshold) {
...
Java_com_wzt_yolov5_LSTR_advancedKeyCheck(JNIEnv *env, jclass, jlong advanced_key ) {
    return true;
}
